...
/** Mensagens de exemplo, no espírito de um grupo de WhatsApp/Discord da comunidade. */
const PESSOAS = {
...
const MESSAGES = [
  ...
  { from: "Breno", img: PESSOAS.breno, text: "Vi o laudo, equipamento tava impecável 👌", time: "09:16", mine: false },
];

export function Sobre() {
  return (
    <section id="comunidade" className="relative bg-paper py-24 md:py-32 overflow-hidden">
      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        ...
        {/* Corpo: timeline de uso à esquerda, mockup de chat à direita */}
        <div className="mt-20 grid md:grid-cols-12 gap-12 md:gap-10 items-start">
          ...
          {/* Mockup de chat, tipo grupo de WhatsApp da comunidade */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="mx-auto max-w-sm border border-ink/10 bg-paper card-lift overflow-hidden">
              {/* Cabeçalho do grupo */}
              ...
              {/* Campo de digitação, só decorativo */}
